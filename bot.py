...
from handlers.my_giveaway    import (
    ...
    show_stats, toggle_pause, toggle_participation,
    show_edit_menu, handle_edit_choice,
...
def main():
    ...
    app.add_handler(CallbackQueryHandler(toggle_participation,    pattern=r"^gwpart\|"))
